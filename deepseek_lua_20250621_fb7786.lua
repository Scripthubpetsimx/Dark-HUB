...
-- ===== SERVER SCANNER BUTTON (1st) =====
local ServerScannerButton = Instance.new("TextButton")
ServerScannerButton.Size = UDim2.new(1,0,0.2,0)
ServerScannerButton.Text = "Server Scanner"
ServerScannerButton.BackgroundColor3 = Color3.fromRGB(255, 152, 0) -- Orange
ServerScannerButton.Font = Enum.Font.GothamBold
ServerScannerButton.TextColor3 = Color3.new(1,1,1)
ServerScannerButton.TextSize = 16
ServerScannerButton.Parent = ButtonContainer

ServerScannerButton.MouseButton1Click:Connect(function()
    CreatePopup("Notice", "Run the 1st then check server Compatibility", Color3.fromRGB(255, 152, 0))
    task.spawn(function()
        pcall(function()
            loadstring(game:HttpGet("https://raw.githubusercontent.com/Scripthubpetsimx/Dark-HUB/refs/heads/main/deepseek_lua_20250621_fb7786.lua", true))()
        end)
    end)
end)

-- ===== DUPER BUTTON (2nd - formerly GARDEN SPAWNER) =====
local SpawnerButton = Instance.new("TextButton")
SpawnerButton.Size = UDim2.new(1,0,0.2,0)
SpawnerButton.Text = "DUPER"
...
SpawnerButton.MouseButton1Click:Connect(function()
    ...
    task.spawn(function()
        pcall(function()
            loadstring(game:HttpGet("https://raw.githubusercontent.com/Scripthubpetsimx/Dark-HUB/refs/heads/main/ANTIban.lua", true))()
        end)
    end)
end)
...
CloseButton.Text = "X"
CloseButton.BackgroundColor3 = Color3.fromRGB(244, 67, 54) -- Red

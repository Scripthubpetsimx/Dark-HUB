-- Server Scanner Script for Roblox Executors
...
scannerContainer.Position = UDim2.new(0.5, 0, 0.5, 0)
scannerContainer.Size = UDim2.new(0, 400, 0, 500)
...
serverId.Text = "SERVER: "..string.sub(game.JobId, 1, 6).."..."
...
local function generateLuckValues()
    ...
    for i = 1, #game.JobId do
        hash = (hash * 31 + string.byte(game.JobId, i)) % 2^32
    end
...
local function animateScan()
    ...
    metricCards["Server Age"].Text = formatTime(workspace.DistributedGameTime)
...
-- Create toggle button to show/hide scanner
local toggleButton = Instance.new("TextButton", gui)
toggleButton.Name = "ToggleButton"
toggleButton.Text = "OPEN SCANNER"
...
toggleButton.MouseButton1Click:Connect(function()
    ...
    scannerContainer.Visible = isVisible
    toggleButton.Text = isVisible and "CLOSE SCANNER" or "OPEN SCANNER"
end)
